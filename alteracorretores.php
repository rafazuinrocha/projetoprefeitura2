                  ...
                  if(ISSET($_SESSION['nivel']))
                   {
                    ...
                    <section class="page-section sistema" id="sistema">
                        <div class="container">
                             <h6 class="page-section-heading text-center text-uppercase text-secondary mb-0">ALTERAÇÃO REALIZADA -  <?php echo trata_injection($_POST["nome"]); ?></h6> 
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 mx-auto">
                                    ...
                                    <?php
                                        ...
                                        $codigo = trata_injection($_POST["codigo"]);    
                                        ...
                                        $status =1;
                                            ...
                                            $sql = "update tbcorretores set nome='$nome', email='$email', rg='$rg', cpf='$cpf',  celular='$celular', creci='$creci', endereco='$endereco', cidade='$cidade', banco='$banco', agencia='$agencia', conta='$conta', tipopix='$tipopix', pix='$pix', unidade='$unidade', mql='$mql', status='$status' where codigo='$codigo'"; 

                                            $resul = mysqli_query($con, $sql) or die ("Erro na alteração");
