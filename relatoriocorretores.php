                  ...
                  if(ISSET($_SESSION['nivel']))
                   {
                    ...
                    <header class="masthead1 bg-primary text-white text-center" id="about">
                        <div class="container d-flex align-items-center flex-column">
                         <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0"> Corretores - <?php echo $unidade;?> 
                         </h2>
                            <!-- Icon Divider-->
                    ...
                    <section class="page-section sistema" id="sistema">
                        <div class="container">
                             <h6 class="page-section-heading text-center text-uppercase text-secondary mb-0">RELATÓRIOS</h6> 
                             ...
                             <div class="row">
                                <div class="col-lg-12 mx-auto">
                                    ...
                                    <div class="form-group">
                                            ...
                                            $query = "SELECT * from tbcorretores where unidade = '$unidade' and status='1' order by nome";
                                            ...
                                            else
                                            {
                                                ...
                                                while($row = $result->fetch_assoc())
                                                {
                                                    ...
                                                    echo '<table class="responsive"><tr>';
                                                    echo "<td bgcolor='#ffc890'> <h5> <b> Codigo: ".$row["codigo"]."</h5></td> </table>";
                                                    echo "<b>Nome: </b>".$row["nome"]."&nbsp; &nbsp; &nbsp;";
                                                    echo "<b>Email: </b>".$row["email"]."&nbsp; &nbsp; &nbsp;";
                                                    echo "<b>CPF: </b>".$row["cpf"]."&nbsp; &nbsp; &nbsp;";
                                                    echo "<b>RG: </b>".$row["rg"]."<br>";
                                                    echo "<b>Celular: </b>".$row["celular"]."&nbsp; &nbsp; &nbsp;";
                                                    echo "<b>CRECI: </b>".$row["creci"]."&nbsp; &nbsp; &nbsp;";
                                                    echo "<b>Endereço: </b>".$row["endereco"]."&nbsp; &nbsp; &nbsp;";
                                                    echo "<b>Cidade: </b>".$row["cidade"]."<br>";
                                                    echo "<b>Banco: </b>".$row["banco"]."&nbsp; &nbsp; &nbsp;";
                                                    echo "<b>Agência: </b>".$row["agencia"]."&nbsp; &nbsp; &nbsp;";
                                                    echo "<b>Conta: </b>".$row["conta"]."<br>";
                                                    echo "<b>Tipo de Pix: </b>".$row["tipopix"]."&nbsp; &nbsp; &nbsp;";
                                                    echo "<b>Pix: </b>".$row["pix"]."<br>";
                                                    echo "<b>Unidade: </b>".$row["unidade"]."&nbsp; &nbsp; &nbsp;";
                                                    echo "<b>MQL: </b>".$row["mql"]."<br>";
