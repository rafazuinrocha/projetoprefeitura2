    ...
    <head>
      ...
      */
              ...
              function Excluir(x)
              {
                    ...
                    var r=confirm("Tem certeza que deseja excluir este corretor?");
                    if (r==true)
                    {
                       var exclusao = {
                                'codigo': x
                        ...
                        var dados = JSON.stringify(exclusao);
                                ...
                                $.ajax({
                                url: 'excluircorretor.php',
                                type: 'POST',
                                data: {data: dados},
                                success: function(result){
                                  console.log(data);
                                  alert('Registro Excluído');
                                  window.location.href = "consultacorretores.php";
                                    
                                },
                                error: function(jqXHR, textStatus, errorThrown) {
                                  alert('Avise o administrador pois esta rotina esta com erro ... ROTINA: EXCLUSÃO CORRETOR!');
                                }
                       }); 
                  ...
                  if(ISSET($_SESSION['nivel']))
                   {
                    ...
                    <section class="page-section sistema" id="sistema">
                        <div class="container">
                             <h6 class="page-section-heading text-center text-uppercase text-secondary mb-0">CONSULTA</h6>
                            ...
                            <div class="row">
                                <?php
                                        ...
                                        $corretor = trata_injection($_POST["corretor"]);
                                                           
                                         $query = "SELECT * from tbcorretores where nome ='$corretor'";
                                         $result = mysqli_query($con, $query) or die ("Erro no select  1");
                                         $rowretorno = mysqli_fetch_array($result,MYSQLI_ASSOC);
                                ?>
                                
                             
                                <div class="col-lg-8 mx-auto">
                                     <form method="POST" action="alteracorretores.php">
                                         <input type="hidden" name="codigo" id="codigo"  value ="<?php echo $rowretorno["codigo"];?>"/> 

                                            <div class="control-group">
                                            
                                                <label for="nome">Nome:</label>
                                                    <input class="form-control w-75" id="nome" name="nome" type="text" placeholder="NOME" required="required" data-validation-required-message="Por favor digite o nome do Corretor" maxlength="100"  value ="<?php echo $rowretorno["nome"];?>"/> 
                                             ...
                                             <div class="control-group">
                                                ...
                                                <label for="email">Email:</label>
                                                    <input class="form-control w-75" id="email" name="email" type="email" placeholder="EMAIL" required="required" data-validation-required-message="Por favor digite o email do Corretor"  onBlur="Verificaemail(this)" maxlength="100"   value ="<?php echo $rowretorno["email"];?>"/> 
                                             ...
                                             <div class="control-group">
                                                ...
                                                <input class="form-control w-75" id="rg" name="rg" type="text" placeholder="RG" required="required" data-validation-required-message="Por favor digite o rg"  onkeypress="mascara(this,numerico)" maxlength="18"  value ="<?php echo $rowretorno["rg"];?>" />
                                                <p class="help-block text-danger"></p>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <input class="form-control w-75" id="cpf" name="cpf" type="text" placeholder="CPF" required="required" data-validation-required-message="Por favor digite o cpf"  onkeypress="mascara(this,numerico)" onBlur="Verificacpf(this)"  maxlength="11"   value ="<?php echo $rowretorno["cpf"];?>" required/>
                                                <p class="help-block text-danger"></p>
                                            ...
                                            <div class="control-group">
                                                    ...
                                                    <input type="text" class="form-control w-50" id="celular" name="celular" placeholder="(99) 99999-9999" required="required"       onkeypress="mascara(this,telefone)" maxlength="18"  value ="<?php echo $rowretorno["celular"];?>"/>
                                              ...
                                              <div class="control-group">
                                                ...
                                                <input class="form-control w-75" id="creci" name="creci" type="text" placeholder="CRECI"  maxlength="15"  value ="<?php echo $rowretorno["creci"];?>" />
                                                <p class="help-block text-danger"></p>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <input class="form-control w-75" id="endereco" name="endereco" type="text" placeholder="ENDEREÇO"  maxlength="70"  value ="<?php echo $rowretorno["endereco"];?>" />
                                                <p class="help-block text-danger"></p>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <input class="form-control w-75" id="cidade" name="cidade" type="text" placeholder="CIDADE"  maxlength="70"   value ="<?php echo $rowretorno["cidade"];?>"/>
                                                <p class="help-block text-danger"></p>
                                              ...
                                              <div class="control-group">
                                                ...
                                                <label for="banco">Banco:</label>
                                                    <input class="form-control w-75" id="banco" name="banco" type="text" placeholder="BANCO" required="required" data-validation-required-message="Por favor digite o Banco" maxlength="70"  value ="<?php echo $rowretorno["banco"];?>" /> 
                                              ...
                                              <div class="control-group">
                                                ...
                                                <label for="agencia">Agência:</label>
                                                    <input class="form-control w-75" id="agencia" name="agencia" type="text" placeholder="AGENCIA" required="required" data-validation-required-message="Por favor digite a Agência" maxlength="20"  value ="<?php echo $rowretorno["agencia"];?>" /> 
                                              ...
                                              <div class="control-group">
                                                ...
                                                <label for="conta">Conta:</label>
                                                    <input class="form-control w-75" id="conta" name="conta" type="text" placeholder="CONTA" required="required" data-validation-required-message="Por favor digite a Conta" maxlength="20"  value ="<?php echo $rowretorno["conta"];?>" /> 
                                                          ...
                                                          <select class="form-control" id="tipopix" name="tipopix"  placeholder="TIPO DE PIX" required="required" data-validation-required-message="Por favor escolha tipo de pix" onBlur="Verificapix(this)" >
                                                            ...
                                                            <option selected><< Escolha o Tipo de Pix >></option>
                                                                <?php
                                                                    ...
                                                                    else if($rowretorno["tipopix"] == "EMAIL")
                                                                    {
                                                                    ?>                       
                                                                        <option>aleatório </option>
                                                                        <option>banco, agência, conta e CPF</option>
                                                                    ...
                                                                    else if($rowretorno["tipopix"] == "CPF")
                                                                    {
                                                                    ?>                       
                                                                        <option>aleatório </option>
                                                                        <option>banco, agência, conta e CPF</option>
                                                                     ...
                                                                     else if($rowretorno["tipopix"] == "ALEATÓRIO")
                                                                    {
                                                                    ?>                       
                                                                    ...
                                                                    else if($rowretorno["tipopix"] == "BANCO, AGÊNCIA, CONTA E CPF")
                                                                    {
                                                                    ?>                       
                                                                        <option >aleatório </option>
                                                                        <option selected>banco, agência, conta e CPF</option>
                                                                        <option >celular </option>
                                                                        <option>cpf </option>
                                                                        <option>cnpj </option>
                                                                        <option >email </option>
                                                                     ...
                                                                     else if($rowretorno["tipopix"] == "CNPJ")
                                                                    {
                                                                    ?>                       
                                                                        <option >aleatório </option>
                                                                        <option >banco, agência, conta e CPF</option>
                                             ...
                                             <div class="control-group">
                                                ...
                                                <label for="pix">Pix: (Digite sem espaços e caracteres especiais)</label>
                                                    <input class="form-control w-75" id="pix" name="pix" type="text" placeholder="PIX" required="required" data-validation-required-message="Por favor digite o Pix" maxlength="100"  value ="<?php echo $rowretorno["pix"];?>"/> 
                                             ...
                                             <label for="unidade">Unidade: </label>
                                                          ...
                                                          <select class="form-control" id="unidade" name="unidade"  placeholder="UNIDADE" required="required" data-validation-required-message="Esscolha a Unidade">
                                                            
                                                           
                                                                
                                                              
                                                               <?php
                                                                    if($rowretorno["unidade"] == "BARUERI")
                                                                    {
                                                                    ?>                       
                                                               ...
                                                               <?php 
                                                                    ...
                                                                    else if($rowretorno["unidade"] == "CAMPINAS")
                                                                    {
                                                                    ?>                       
                                                                         <option><< Escolha a Unidade >></option>
                                                               ...
                                                               <?php 
                                                                    ...
                                                                    else if($rowretorno["unidade"] == "INDAIATUBA")
                                                                    {
                                                                    ?>                       
                                                                         <option><< Escolha a Unidade >></option>
                                                                        <option>Barueri</option>
                                                               ...
                                                               <?php 
                                                                    ...
                                                                    else if($rowretorno["unidade"] == "ITU")
                                                                    {
                                                                    ?>                       
                                                                         <option><< Escolha a Unidade >></option>
                                                                        <option>Barueri</option>
                                                               ...
                                                               <?php 
                                                                    ...
                                                                    else if($rowretorno["unidade"] == "JUNDIAÍ")
                                                                    {
                                                                    ?>                       
                                                                         <option><< Escolha a Unidade >></option>
                                                                        <option>Barueri</option>
                                                               ...
                                                               <?php 
                                                                    ...
                                                                    else if($rowretorno["unidade"] == "SOROCABA")
                                                                    {
                                                                    ?>                       
                                                                         <option><< Escolha a Unidade >></option>
                                                                        <option>Barueri</option>
                                                               ...
                                                               <?php 
                                                                    ...
                                                                    else if($rowretorno["unidade"] == "VALINHOS")
                                                                    {
                                                                    ?>                       
                                                                        <option><< Escolha a Unidade >></option>
                                                                        <option>Barueri</option>
                                                    ...
                                                    <tr>
                                                       <td>
                                                           <div class="form-check">
                                                               ...
                                                               <?php
                                                                    if($rowretorno["mql"] == "SIM")
                                                                    {
                                                                    ?>
                                                                          <input class="form-check-input" type="radio" name="mql" id="mql" value="SIM" checked >
                                                                          <label class="form-check-label" for="mql">
                                                                            SIM
                                                                          </label>
                                                                        </div>
                                                                        <div class="form-check">
                                                                          <input class="form-check-input" type="radio" name="mql" id="mql" value="NÃO" >
                                                                          <label class="form-check-label" for="mql">
                                                                            NÃO
                                                                          </label>
                                                                    <?php
                                          ...
                                          <div id="success">
                                          <center> <div class="form-group 2"><button class="btn btn-primary btn-xl" id="enviar" name="enviar" type="submit">Alterar </button>
                                              &nbsp; &nbsp; &nbsp; &nbsp;
                                               <button class='btn btn-primary btn-xl' id='excluir' name='excluir' type='button' onClick=Excluir(<?php echo $rowretorno["codigo"];?>)> Excluir Corretor  </button> </div>
